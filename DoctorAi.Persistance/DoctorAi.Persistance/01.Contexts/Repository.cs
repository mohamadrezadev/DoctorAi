using DoctorAi.Application.Utilities;
using DoctorAi.Domain._01.Entities;
...
{
    protected readonly DoctorAiDbContext DbContext;
    public DbSet<TEntity> Entities { get; }
    public virtual IQueryable<TEntity> Table => Entities;
    public virtual IQueryable<TEntity> TableNoTracking => Entities.AsNoTracking();

    public Repository( DoctorAiDbContext dbContext )
    {
        DbContext = dbContext;
        ...
        where TProperty : class
    {
        ...
        {
            Attach(entity);
            var reference = this.DbContext.Entry(entity).Reference(referenceProperty);
